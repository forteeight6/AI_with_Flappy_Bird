...
class Barrel:
	...
	def __init__(self, eixo_x):
		...
		barrel_img = utils.pygame_barrel_img()
		self.roof_barrel = utils.pygame_flip_image(barrel_img)
		self.barrel_floor = barrel_img

		self.go = False
		self.height, self.roof_pos, self.floor_pos = utils.pygame_define_height(
	...
	def clash(self, bird):
		...
		roof_barrel_mask = utils.pygame_mask(roof_barrel)
		barrel_floor_mask = utils.pygame_mask(barrel_floor)
		...
		point_roof = utils.pygame_overlap(
			mask_bird, args=(
				'roof_barrel_mask', 
				'roof_distance'
			)
		...
		point_floor = utils.pygame_overlap(
			mask_bird, args=(
				'barrel_floor_mask', 
				'floor_distance'
			)
